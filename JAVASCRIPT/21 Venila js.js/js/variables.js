...
document.querySelector('img').style.width = '300px';               // change image width

//////////////////////////////////////////////////////////////////////////////////////////

document.querySelector('#xx').classList.add('added');                 // class add method
//html il input enum tag il classList moolam 'added' enum class add pannukirathu
// ithai uruthippaduththa style.css inai paar

//////////////////////////////////////////////////////////////////////////////////////////

document.querySelector('#yy').classList.remove('rmdir');             // class remove method